...
const EvaluationPanel: React.FC<EvaluationPanelProps> = ({ evaluation, loading }) => {
    ...
    return (
      <div className="glass-effect rounded-2xl p-12 flex flex-col items-center justify-center">
        <div className="relative">
          <div className="absolute inset-0 bg-blue-600 rounded-full blur-3xl opacity-60 animate-pulse"></div>
  ...
  return (
    <div className="glass-effect rounded-2xl overflow-hidden">
      <div className="bg-blue-600 p-8 text-white shadow-xl">
      ...
      <div className="p-8">
        <div className="mb-8 bg-blue-50 border-2 border-blue-300 rounded-2xl p-6 shadow-lg">
        ...
        <div className="space-y-4">
          ...
          {evaluation.scores.map((score, index) => (
            <div key={score.criterionId} className="border-2 border-blue-200/50 bg-white rounded-xl p-5 hover:shadow-lg transition-all duration-300">
        ...
        {evaluation.overallFeedback && (
          <div className="mt-8 bg-blue-50 border-2 border-blue-300 rounded-2xl p-6 shadow-lg">
